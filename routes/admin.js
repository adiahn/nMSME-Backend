...
router.put('/applications/:id/status', [
  body('status')
    .isIn(['submitted', 'under_review', 'shortlisted', 'finalist', 'winner', 'rejected'])
...
router.get('/debug/applications', async (req, res) => {
  try {
    console.log('Debug endpoint: Checking all applications');
    ...
    res.json({
      success: true,
      message: 'Debug endpoint - All applications',
